...
class FracDB(VisionDataset):
    ...
    def __init__(
        ...
        super(FracDB, self).__init__(root, transform=transform,
...
class randomFracDB(FracDB):
    ...
    def __init__(self, corrupt_prob=0.0, num_classes=10, **kwargs):
        super(randomFracDB, self).__init__(**kwargs)
...
class randomFracDB50(FracDB50):
    ...
    def __init__(self, corrupt_prob=0.0, num_classes=100, **kwargs):
        super(randomFracDB50, self).__init__(**kwargs)
        self.n_classes = num_classes
        if corrupt_prob > 0:
            self.corrupt_labels(corrupt_prob)
