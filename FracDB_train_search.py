...
def main():
    ...
    train_data = FracDB.randomFracDB50(root=args.data, train=True, download=True, transform=train_transform,
                                       corrupt_prob=args.label_corrupt_prob, num_classes=args.num_class)

    val_data = FracDB.randomFracDB50(root=args.data, train=True, download=True, transform=valid_transform,
                                     corrupt_prob=args.label_corrupt_prob, num_classes=args.num_class)
